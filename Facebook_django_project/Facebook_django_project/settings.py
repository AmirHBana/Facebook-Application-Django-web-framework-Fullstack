"""
Django settings for Facebook_django_project project.
...
SECRET_KEY = 'django-insecure-+!212bi07&!bpc$vbzpf(nls%*1^s!l2#301p$ealcn=2jj@y6'
...
ASGI_APPLICATION = 'facebook_django_project.asgi.application'
...
ROOT_URLCONF = 'Facebook_django_project.urls'
...
WSGI_APPLICATION = 'Facebook_django_project.wsgi.application'
...
JAZZMIN_SETTINGS = {
    ...
    "welcome_sign": "Welcome to the Facebook Admin, Login now",
    "topmenu_links": [
