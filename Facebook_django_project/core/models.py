...
class FriendRequest(models.Model):
    ...
    sender = models.ForeignKey(User, on_delete=models.CASCADE, related_name='fsender')

    receiver = models.ForeignKey(User, on_delete=models.CASCADE, related_name='freceiver')
...
class Notification(models.Model):
    ...
    notification_type = models.CharField(max_length=500, choices=NOTIFICATION_TYPES)
...
class ChatMessage(models.Model):
    ...
    reciever = models.ForeignKey(User, on_delete=models.SET_NULL, null=True, blank=True, related_name='reciever')
