...
from core.models import (Post, Gallery, ReplyComment, Comment, Friend, FriendRequest, Notification, Group,
                         GroupPost, Page, PagePost, ChatMessage)
...
class GroupPostTabAdmin(admin.ModelAdmin):
